...
namespace LaunchPlatformPlugin.Actions
{
    ...
    public class CustomPathPlatform : Platform
    {
        public override string ProcessName => "dragonageinquisition.exe";
        public override string RegistryKey => ""; // No registry key needed for custom path
        public override string RegistryValue => ""; // No registry value needed for custom path
        public override string AdditionalExecutablePath => @"Z:\_Omega\Games\Video Games\Windows (Microsoft)\Dragon Age - Inquisition\DragonAgeInquisition.exe"; //This is hard-coded, and realistically the ONLY thing you should need to change to compile the plugin.
    }
    ...
    public class LaunchExecutionAction : ExecutionAction
    {
        ...
        private readonly Dictionary<LaunchPlatform, Platform> m_platforms = new Dictionary<LaunchPlatform, Platform>
        {
            ...
            { LaunchPlatform.CustomPath, new CustomPathPlatform() },
        };
